...
description: trifold.eng.br é reivindicado por uma conta Vercel de terceiro — todo domínio adicionado no time trifold-s-projects exige TXT em _vercel.trifold.eng.br
metadata:
  type: project
---
...
o TXT propagar. Ver também [[project-vercel-static-deploy-cdn-stale]].
