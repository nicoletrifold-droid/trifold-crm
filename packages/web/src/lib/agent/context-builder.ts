...
export async function buildGlobalContext(
  ...
  // As 3 queries de proveniência (Story 76-1) entram no MESMO Promise.all para não
  // adicionar round-trips sequenciais (AC7) e serem cacheadas junto com o restante.
  const [
    campaignsRes,
    insights30dRes,
    alertsRes,
