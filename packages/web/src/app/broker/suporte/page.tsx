    ...
    <div>
      <div className="mb-8">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-stone-800">
            <MessageSquarePlus className="h-5 w-5 text-stone-400" />
          </div>
          <div>
            <h1 className="text-xl font-bold text-white">Suporte e Melhorias</h1>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
        <div className="rounded-2xl border border-stone-800 bg-stone-900 p-6">
          <h2 className="mb-5 text-base font-semibold text-white">Abrir novo ticket</h2>
          <ChamadoForm userName={user.name} />
        </div>

        <div>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-base font-semibold text-white">Meus tickets</h2>
