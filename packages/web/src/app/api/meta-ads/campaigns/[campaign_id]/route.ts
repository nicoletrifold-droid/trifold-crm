...
export async function GET(
  ...
  //
  // Hotfix de segurança (migration 193 / auditoria P2): `meta_campaign_roas` NÃO é uma view —
  ...
  //
  // A 193 revoga a matview de `anon` E de `authenticated`. Por isso esta leitura passa a usar
