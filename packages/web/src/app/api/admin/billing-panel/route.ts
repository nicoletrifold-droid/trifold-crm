...
//
// Hotfix de segurança (migration 193 / auditoria P4): estas tabelas guardam o custo que a
...
// cobrança é custo + markup, deduziria nossa margem. A migration 193 revoga `authenticated`
...
// client de usuário do requireAuth() — que a partir da 193 receberia lista vazia.
...
export async function GET() {
  ...
  // Tabelas de plataforma (sem org_id) — leitura só por service-role (migration 193).
