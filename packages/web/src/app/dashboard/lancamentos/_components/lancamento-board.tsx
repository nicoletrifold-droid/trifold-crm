...
export function LancamentoBoard({ lancamentoId, initialColumns }: { lancamentoId: string; initialColumns: BoardColumn[] }) {
  ...
  return (
    <>
      ...
      {openCard && (
        <LancamentoCardModal card={openCard} onClose={() => setOpenCard(null)} onUpdated={onCardUpdated} onDeleted={onCardDeleted} />
      )}
    </>
  )
}
