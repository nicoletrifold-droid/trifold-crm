...
type FormState = {
  ...
  gerente_nome: string; contato_nome: string; contato_telefone: string; contato_email: string
  status: ImobiliariaStatus; observacoes: string
}

const EMPTY: FormState = {
  nome: "", razao_social: "", cnpj: "", telefone: "", email: "", cidade: "", estado: "",
  endereco: "", num_corretores: "", gerente_nome: "", contato_nome: "", contato_telefone: "",
  contato_email: "", status: "prospeccao", observacoes: "",
}
...
function toForm(i: Imobiliaria): FormState {
  return {
    ...
    gerente_nome: i.gerente_nome ?? "", contato_nome: i.contato_nome ?? "",
