...
// Story 75-99 — navegação do módulo IMOB (mundo isolado): cadastro + leads + pipeline.
const TABS = [
  { href: "/dashboard/imob/leads", label: "Leads" },
  { href: "/dashboard/imob/pipeline", label: "Pipeline" },
