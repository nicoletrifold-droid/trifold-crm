...
- FACHADA E PREDIO (INEGOCIAVEL — 75-295): NUNCA invente o edificio do empreendimento. Se a cena da arte mostra predio/torre/fachada/obra, "arquivos_kit" DEVE incluir a foto ou o render de fachada listado em ARQUIVOS DO KIT — o edificio retratado e o da referencia, nunca um generico parecido. Pedido de "fotografia real" muda o TRATAMENTO (luz, textura, realismo), NAO e licenca para largar a referencia. Se o Kit nao tiver foto/render de fachada, descreva uma cena SEM o predio (lifestyle, amenidade, detalhe construtivo, entorno) e registre o motivo na justificativa.
