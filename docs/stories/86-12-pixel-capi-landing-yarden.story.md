...
- `landing-pages/yarden/assets/` — **12 arquivos**, recortes do mockup "Yarden LP
  v1.png" (rodada 0.9). Nenhum é ignorado pelo git (`git check-ignore` vazio nos
  12) e nenhum é órfão — há teste exigindo que os dois sentidos fechem
