...
| `org_integrations` | `900-21` (esqueleto) | `900-47` (`secret_ref`/Vault, índices de roteamento reverso, `resolveIntegration`) | `900-21` | **Movido de `900-47` (B2)** — a Onda 7 é sob demanda e pode nunca acontecer |
...
#### 900-23 — 37 crons iteram orgs (`forEachActiveOrg`) — fim do `DEFAULT_ORG_ID`
