...
- 2026-07-02 — @devops — Commit `7e2b50c`, push branch feat/75-111, **PR #108** aberto. PENDENTE: (1) merge do PR (Vercel deploy) e (2) aplicar migration 153 no Supabase de prod (`dsopqkqjkmhytudaaolv`) ANTES/junto do deploy do frontend. Status → aguardando merge + migration.
