...
| 2026-08-04 | 0.3 | QA gate (@qa Quinn): CONCERNS, nenhum HIGH. Fixes aplicados: REL-001 (.order na paginação), MNT-002 (rótulos importados da fonte), MNT-005 (UUID nomeado), DOC-006 (%% no COMMENT) + TEST-007 (5 testes vitest das funções puras). REL-003 (drag-out do Kanban não limpa lost_reason — pré-existente) vira follow-up. AC6 = validação pós-deploy registrada. | @qa / @dev |
