...
| 2026-05-18 | 1.3 | Status Done + push SHA `2e1d58f` → origin/main. Arquivos: `supabase/migrations/045_meta_insights_synced_at.sql`, `docs/stories/active/16-14-meta-insights-synced-at-column.md`, `docs/qa/gates/16.14-meta-insights-synced-at-column.yml`. Hotfix já estava em prod via Management API; commit sincroniza histórico. | Gage (@devops) |
