...
- [Sibling-story reuse audit](feedback_validate_sibling_story_reuse_audit.md) — Story portada de outra: listar módulos da irmã, caçar literais da entidade antiga, e checar invariante do destino que a irmã viola
...
- [Retomar story de sessão interrompida](feedback_retomar_story_sessao_interrompida.md) — o cabeçalho é o que mente: auditar ACs, Change Log citado e blockquotes antes de confiar no Status
