...
**Gotcha 2 — path do NODE_PATH.** O que funciona é `node_modules/.pnpm/playwright@1.60.0/node_modules`. A variante `@playwright+test@1.60.0/...` citada em [[vercel-landing-pages-projects]] é o pacote de test runner, não o `require('playwright')`. (Ambos os diretórios existem no monorepo — o erro é silencioso e vira "module not found".)
